...
const formItemVariants = cva(
  'w-full',
  {
    variants: {
      variant: {
        default: '',
        bordered: 'border border-secondary rounded-md p-4',
        underlined: 'border-b border-secondary pb-4',
      },
      required: {
        true: '',
      },
...
export const FormLabel = ({
  ...
  <label
    className={cn("block text-sm font-medium text-content-body mb-1.5", className)}
    {...props}
  >
    {children}
  </label>

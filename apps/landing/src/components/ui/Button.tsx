...
const buttonStyles = cva(
  "!bg-transparent !text-black !shadow-none !flex !items-center rounded-none! !justify-center !gap-2 !font-medium !transition-colors focus:!outline-none focus:!ring-2 focus:ring-ring focus-visible:outline-hidden focus:ring-offset-2 disabled:pointer-events-none disabled:!cursor-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
